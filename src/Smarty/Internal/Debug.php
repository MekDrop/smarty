...
class Debug extends Data
{
     ...
     *
     * @param SmartyData $data data object
     */
    public static function register_data(SmartyData $data)
    {
    }
    ...
    public function display_debug($obj, $full = false)
    {
        ...
        $_template = new Template($debObj->debug_tpl, $debObj);
        if ($obj->_isTplObj()) {
     ...
     *
     * @param Template|SmartyData $obj object to debug
     *
     * @return \StdClass
     */
