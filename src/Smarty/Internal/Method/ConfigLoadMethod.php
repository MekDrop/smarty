...
class ConfigLoadMethod
{
     ...
     *                                                                             section or null
     *
     * @return \Smarty|\Smarty\Internal\Data|\Smarty\Internal\Template
     * @throws \Exception
     */
    public function configLoad(\Smarty\Internal\Data $data, $config_file, $sections = null)
    {
     ...
     * @throws \Exception
     */
    public function _loadConfigFile(\Smarty\Internal\Data $data, $config_file, $sections = null, $scope = 0)
    {
        /* @var \Smarty $smarty */
        $smarty = $data->_getSmartyObj();
        /* @var \Smarty\Internal\Template $confObj */
        $confObj = new \Smarty\Internal\Template($config_file, $smarty, $data, null, null, null, null, true);
        $confObj->caching = \Smarty::CACHING_OFF;
        $confObj->source->config_sections = $sections;
        $confObj->source->scope = $scope;
        $confObj->compiled = \Smarty\Template\CompiledTemplate::load($confObj);
     ...
     */
    public function _loadConfigVars(\Smarty\Internal\Template $tpl, $new_config_vars)
    {
        ...
        if ($tagScope >= 0) {
            ...
            if ($tpl->parent->_isTplObj() && ($tagScope || $tpl->parent->scope)) {
                ...
                if ($mergedScope) {
                    // update scopes
                    /* @var \Smarty\Internal\Template|\Smarty|\Smarty\Internal\Data $ptr */
     ...
     */
    public function _assignConfigVars(&$config_vars, \Smarty\Internal\Template $tpl, $new_config_vars)
    {
     ...
     */
    public function _updateVarStack(\Smarty\Internal\Template $tpl, $config_vars)
    {
        $i = 0;
     ...
     */
    public function _getConfigVariable(\Smarty\Internal\Data $data, $varName, $errorEnable = true)
    {
        $_ptr = $data;
        while ($_ptr !== null) {
