...
class ConfigLoadMethod
{
     ...
     *                                                                             section or null
     *
     * @return Smarty|Data|Template
     * @throws Exception
     *
     * @link https://www.smarty.net/docs/en/api.config.load.tpl
     * @api  Smarty::configLoad()
     */
    public function configLoad(Data $data, $config_file, $sections = null)
    {
     ...
     * @api  Smarty::configLoad()
     */
    public function _loadConfigFile(Data $data, $config_file, $sections = null, $scope = 0)
    {
        /* @var Smarty $smarty */
        $smarty = $data->_getSmartyObj();
        /* @var Template $confObj */
        $confObj = new Template($config_file, $smarty, $data, null, null, null, null, true);
        $confObj->caching = Smarty::CACHING_OFF;
        $confObj->source->config_sections = $sections;
        $confObj->source->scope = $scope;
        $confObj->compiled = CompiledTemplate::load($confObj);
     ...
     */
    public function _loadConfigVars(Template $tpl, $new_config_vars)
    {
     ...
     */
    public function _assignConfigVars(&$config_vars, Template $tpl, $new_config_vars)
    {
     ...
     */
    public function _updateVarStack(Template $tpl, $config_vars)
    {
        $i = 0;
     ...
     */
    public function _getConfigVariable(Data $data, $varName, $errorEnable = true)
    {
        $_ptr = $data;
        while ($_ptr !== null) {
